...
export function DivisionCard({
  ...
  const colorConfig = {
    grocery: {
      ...
      gradient:
        "radial-gradient(circle at center, rgba(229, 62, 62, 0.15) 0%, transparent 70%)",
    },
    industrial: {
      solid: "var(--color-industrial)",
      gradient:
        "radial-gradient(circle at center, rgba(213, 63, 140, 0.15) 0%, transparent 70%)",
    },
    construction: {
      ...
      <Link href={href} className="block group relative">
        ...
        <motion.div
          ...
          style={{
            ...
            transformStyle:
              performanceMode === "high" ? "preserve-3d" : undefined,
          }}
          whileHover={{
            scale: 1.03,
            y: -8,
