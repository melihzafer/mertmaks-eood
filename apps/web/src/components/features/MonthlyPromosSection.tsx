...
interface MonthlyPromosSectionProps {
  promotions: MonthlyPromotion[];
  accentColor?: string;
}

export function MonthlyPromosSection({
  promotions,
  accentColor = "#E53E3E",
}: MonthlyPromosSectionProps) {
    ...
    <section className="section-tight rule">
      <div className="container">
        <div className="indexed-head">
          ...
          <div>
            <div className="eyebrow">Месечни оферти</div>
            <h2>Оферти този месец</h2>
            <p className="lead">
              По-дългосрочни промоции и кампании за текущия месец.
            </p>
          </div>
        </div>
