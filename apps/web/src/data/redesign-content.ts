...
export const divisionPages = {
  ...
  industrial: {
    ...
    intro: {
      index: "02",
      eyebrow: "Категории",
      title: "Стоки за домакинството и семейството.",
    },
    cards: [
      {
        wide: true,
  ...
  construction: {
    ...
    intro: {
      index: "02",
      eyebrow: "Категории",
      title: "Материали за вашия ремонт и строеж.",
    },
    cards: [
      {
        wide: true,
...
export const aboutPage = {
  eyebrow: "ЗА НАС",
  title: "Местен бизнес с корени в Самуил.",
  lead: "От 2005 година МЕРТМАКС е надежден партньор за домакинствата в Самуил и региона. Трите ни направления — хранителен магазин, домашни потреби и строителни материали — покриват ежедневните нужди на местните хора с качество и човешко отношение.",
  stats: [
    { value: 20, suffix: "+", label: "години" },
    { value: 4, suffix: "", label: "обекта" },
    { value: 100, suffix: "+", label: "марки" },
    { value: 7, suffix: "", label: "дни" },
  ],
  events: [
    {
      ...
      title: "2005",
      description:
        "МЕРТМАКС започва като малък семеен магазин в центъра на Самуил. От самото начало подходът е личен — клиентите идват за стоките, но остават заради отношението.",
    },
    {
      color: accents.industrial,
      title: "2010",
      description:
        "Към хранителния магазин добавяме домакински потреби, посуда, текстил и дребни стоки — нещата, които спестяват едно пътуване до града.",
    },
    {
      color: accents.construction,
      title: "2015",
      description:
        "Отваряме строителна база за материали, бои и инструменти. Майстори и домакинства вече не трябва да ходят далеч за ремонта или обекта си.",
    },
    {
      color: accents.restaurant,
      title: "2020",
      description:
        "Ресторант Делиорман разширява предложението — топла храна, обедно меню и място за срещи след пазаруване. Четирите обекта вече работят заедно.",
    },
    {
      color: accents.supermarketAccent,
      title: "2025",
      description:
        "Обновяваме обектите, подобряваме обслужването и продължаваме да инвестираме в Самуил — същите хора, същата отговорност, повече възможности.",
    },
  ],
  values: [
    {
      icon: "🤝",
      title: "Общност",
      desc: "Ние сме част от Самуил. Всеки магазин работи за хората, които познаваме по име.",
    },
    {
      icon: "✓",
      title: "Качество",
      desc: "Подбираме продукти, които бихме взели и за собствените си домове.",
    },
    {
      icon: "💚",
      title: "Доверие",
      desc: "Коректност, постоянство и отговорност — не на думи, а в ежедневната работа.",
    },
  ],
  quote:
...
// @deprecated — use `aboutPage` instead. Kept for backward compatibility.
export const samuilHubPage = aboutPage;
