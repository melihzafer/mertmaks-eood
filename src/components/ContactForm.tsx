...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      setFormData({ name: '', email: '', phone: '', store: undefined, message: '' });
  ...
  return (
    <div className='max-w-2xl mx-auto px-4'>
      <h2 className='text-3xl font-bold mb-8 text-center'>Изпратете ни съобщение</h2>
      ...
      <form onSubmit={handleSubmit} className='space-y-6'>
        ...
        <div className='space-y-2'>
          ...
          <Select
            ...
            onValueChange={(value: string) => setFormData({ ...formData, store: value })}
            disabled={loading}
          >
